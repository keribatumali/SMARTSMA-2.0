        ...
        {DAYS.map(day => {
          ...
          return (
            <motion.div 
              ...
              variants={itemVariants}
              whileHover={{ y: -5 }}
              className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm flex flex-col"
            >
                  ...
                  {items.length > 0 ? (
                    items.map((item) => (
                      <motion.div 
                        ...
                        className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/30 rounded-xl group transition-all hover:bg-slate-100 dark:hover:bg-slate-800/50"
                      >
